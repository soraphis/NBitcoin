...
namespace NBitcoin.Secp256k1
{
	readonly struct GroupElementJacobian
	{
		...
		internal readonly FieldElement z;
		...
		public GroupElementJacobian(in FieldElement x, in FieldElement y, in FieldElement z)
		{
			this.x = x;
			this.y = y;
			this.z = z;
		...
		public readonly GroupElementJacobian AddVariable(in GroupElement b, out FieldElement rzr)
		{
			...
			FieldElement z12, u1, u2, s1, s2, h, i, i2, h2, h3, t;
			if (a.infinity)
			{
				rzr = default;
			...
			if (b.infinity)
			{
				rzr = new FieldElement(1U);
				return a;
			}
			var (rx, ry, rz, rinfinity) = default(GroupElementJacobian);
			rinfinity = false;
		...
		public readonly GroupElementJacobian AddVariable(in GroupElementJacobian b, out FieldElement rzr)
		{
			...
			FieldElement z22, z12, u1, u2, s1, s2, h, i, i2, h2, h3, t;
			if (a.infinity)
			{
				rzr = default;
				return b;
			...
			if (b.infinity)
			{
				rzr = new FieldElement(1);
				return a;
			}

			FieldElement rx, ry, rz;
			bool rinfinity;
			rinfinity = false;
			z22 = b.z.Sqr();
			z12 = a.z.Sqr();
		...
		public readonly GroupElementJacobian AddZInvVariable(in GroupElement b, in FieldElement bzinv)
		{
			ref readonly GroupElementJacobian a = ref this;
			/* 9 mul, 3 sqr, 4 normalize, 12 mul_int/add/negate */
			FieldElement az, z12, u1, u2, s1, s2, h, i, i2, h2, h3, t;
			FieldElement rx, ry, rz;
			bool rinfinity;
			if (b.infinity)
			{
			...
			if (a.infinity)
			{
				FieldElement bzinv2, bzinv3;
				rinfinity = b.infinity;
				bzinv2 = bzinv.Sqr();
				bzinv3 = bzinv2 * bzinv;
				rx = b.x * bzinv2;
				ry = b.y * bzinv3;
				rz = new FieldElement(1);
				return new GroupElementJacobian(rx, ry, rz, rinfinity);
			}
			rinfinity = false;
   ...
   */
     ...
     */
		...
		public readonly GroupElement ToGroupElementVariable()
		{
			FieldElement x, y;
			bool infinity;
		...
		public static GroupElementJacobian SECP256K1_GEJ_CONST(uint a, uint b, uint c, uint d, uint e, uint f, uint g, uint h, uint i, uint j, uint k, uint l, uint m, uint n, uint o, uint p)
		{
			return new GroupElementJacobian(
				FieldElement.SECP256K1_FE_CONST(a, b, c, d, e, f, g, h),
				FieldElement.SECP256K1_FE_CONST(i, j, k, l, m, n, o, p),
				FieldElement.SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 1),
				false
				);
		}
		...
		public readonly GroupElementJacobian Add(in GroupElement b)
		{
			...
			FieldElement zz, u1, u2, s1, s2, t, tt, m, n, q, rr;
			FieldElement m_alt, rr_alt;
